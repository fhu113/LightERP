...
CMD cd /app && npx prisma db push --schema=packages/backend/prisma/schema.postgresql.prisma --accept-data-loss --skip-generate && node packages/backend/dist/server.js
